...
A = tril(rand(10),-1); % -1 means returning tri-matrix below diagonal
A = A + A'; 
[V, D] = eig(A);
...
orth_nullA = orth(null(A'));% null() returns the orthonormal basis of null space
